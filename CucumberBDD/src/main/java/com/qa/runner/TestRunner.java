...
@CucumberOptions(
        features="C:\\Users\\SwapnilN3\\git\\Projects\\CucumberBDD\\src\\main\\java\\com\\qa\\Features",  // It contains path to feature files
        ...
        dryRun=true,		// if this is true then it will check mapping. If false it will execute the project
